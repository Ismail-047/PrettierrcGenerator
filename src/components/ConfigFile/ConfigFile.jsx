            ...
            <div className="codeMainContainer">
               ...
               >
                  ...
                  <div className="keyValueContainer">
                     ...
                     {tabs && (
                        <>
                           <span className='keys'>"useTabs":</span>
                     ...
                     {quotes && (
                        <>
                           <span className='keys'>"singleQuote":</span>
                     ...
                     {jsxBrackets && (
                        <>
                           <span className='keys'>"jsxBracketSameLine":</span>
                     ...
                     {trailingCommas && (
                        <>
                           <span className='keys'>"trailingComma":</span>
                     ...
                     {arrowFunctionParentheses && (
                        <>
                           <span className='keys'>"arrowParens":</span>
